/**
 * This frame is used for pursuing books for borrowers
 */
package gui;
...
public class BorrowFrame extends javax.swing.JFrame {
     ...
     */
    public BorrowFrame(Database database, String ISBN, Map<String, Title> titles,
            ...
            if (this.borrowers.containsKey(borrowerId)) {
                ...
                if (this.database.insertBorrowerISBN(borrowerISBN)) {
                    ...
                    if (this.borrowerISBNs != null) {
                        ...
                        this.borrowerISBNs = new ArrayList<>();
                        this.borrowerISBNs.add(borrowerISBN);
                    }
